...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'napomena'         => isset($query->row['napomena']) ? $query->row['napomena'] : '',
                ...
                'price_ponuda'          => $query->row['price_ponuda'],
                'price_last_30'    => $this->getProductLowestPrice($product_id),
	...
	public function getProductImages($product_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_image WHERE product_id = '" . (int)$product_id . "'  ORDER BY sort_order ASC LIMIT 0,19");
